...
SEEDS="${SEEDS:-42}"
RANKING_SIZES="${RANKING_SIZES:-2 3 4}"
...
if [[ ! -d "${DATASET_DIR}" ]]; then
  ...
  echo "Generate a two-dimension disagreement dataset first." >&2
  exit 1
fi
...
BASE_OUTPUT_DIR="${OUTPUT_DIR:-outputs/ultrafeedback-disagreement/mixture-pl-two-dim/qwen3-0.6b-${dataset_tag}}"
BASE_WANDB_NAME="${WANDB_NAME:-qwen3-0.6b-mixture-pl-${dataset_tag}}"
